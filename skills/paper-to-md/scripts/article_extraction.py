...
def extract_abstract(sections: list[Section], front_matter: dict) -> tuple[str, list[str], str]:
    abstract_sections, _ = collect_named_run(sections, ABSTRACT_HEADINGS)
    if abstract_sections:
        return collapse_lines(abstract_sections[0].content_lines), [abstract_sections[0].heading], "section"
